...
//            int x = imgroom.getSize().width;
//            int y = imgroom.getSize().height;
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(imgroom, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 410, 180, 150));
...
//        img = imgroom.getText();
        if (room_num.equals("") || price.equals("")) {
            ...
            Room r1 = new Room(room_num, type_room, floor, Float.parseFloat(price.getText()), filename);
    ...
    private void browse_imgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browse_imgActionPerformed
        ...
        JFileChooser browserImageFile = new JFileChooser(url.getPath().replaceAll("%20", " "));
