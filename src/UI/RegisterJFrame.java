...
public class RegisterJFrame extends javax.swing.JFrame {
    ...
    private void Sign_upActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Sign_upActionPerformed
        ...
        boolean checkName = !(PatternForm.GetName(username));
        boolean checkEmail = !(PatternForm.GetEmail(temail));
        boolean checkPhone = !(PatternForm.GetMobile(mobile));
        ...
        if (username.equals("") || temail.equals("") || mobile.equals("") || birthday.equals("") || pwd.equals("") || cpwd.equals("")) {
            sb.append("Hãy nhập đầy đủ thông tin");
        ...
        sb.append("Tạo tài khoản thành công");
        JOptionPane.showMessageDialog(this, sb.toString(), "Success", JOptionPane.INFORMATION_MESSAGE);
        User std = new User(username, temail, birthday, mobile, gender, pwd);
...
//        JOptionPane.showMessageDialog(this, sb.toString(), "Invalid",
